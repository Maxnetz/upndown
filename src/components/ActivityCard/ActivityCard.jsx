...
const ActivityCard = () => {
    const { activities, deleteActivity, setEditActivity } = useAppContext();
                        ...
                        >
                            ...
                            <div className="card-body items-center text-center">
                                ...
                                <div className="card-actions">
                                    <Link
                                        to="/editActivity"
                                        className="text-center focus:outline-none text-black bg-yellow-300 hover:bg-yellow-400 focus:ring-4 focus:ring-indigo-300 font-medium rounded-xl text-sm px-5 py-2.5 mb-2 dark:bg-indigo-600 dark:hover:bg-indigo-800 dark:focus:ring-indigo-400 "
                                        onClick={() =>
                                            setEditActivity(activity._id)
                                        }
                                    >
                                        Edit
                                    </Link>
